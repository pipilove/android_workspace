...
public class CopyOfGroupDetailsActivity extends BaseActivity implements
        OnClickListener {
    ...
    public static CopyOfGroupDetailsActivity instance;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (progressDialog == null) {
                progressDialog = new ProgressDialog(CopyOfGroupDetailsActivity.this);
    ...
    public void onClick(View v) {
            ...
            if (iv_switch_block_groupmsg.getVisibility() == View.VISIBLE) {
                ...
                if (progressDialog == null) {
                    progressDialog = new ProgressDialog(
                            CopyOfGroupDetailsActivity.this);
                    progressDialog.setCanceledOnTouchOutside(false);
                }
        ...
        case R.id.clear_all_history: // 清空聊天记录
            ...
            Intent intent = new Intent(CopyOfGroupDetailsActivity.this,
                    AlertDialog.class);
        ...
        case R.id.rl_blacklist: // 黑名单列表
            startActivity(new Intent(CopyOfGroupDetailsActivity.this,
